...
class App {
	...
	_setupModel() {
		// 이 재질은 표면에 코팅 효과를 주고, 실제 유리 같은 효과를 냄
		const material = new THREE.MeshPhysicalMaterial({
			color: 0xff0000, // 재질의 색상
			emissive: 0x00000, // 다른 광원에 영향을 받지 않는 재질 자체에서 방출하는 색상 값, 기본값:black, 방출하지 않음
			roughness: 1, // 거칠기 (0: 거칠기가 없는 상태, 거울과 같은 상태)
			metalness: 0, // 금속성 (0: 돌 처럼 금속성이 없는 상태 / 1: 금속상태)
			clearcoat: 1, // 0: 코팅X / 1: 코팅
			clearcoatRoughness: 0, // 0: 매끄러움 / 1: 거침
