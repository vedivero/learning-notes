package vedivero.board.article.api;
...
public class ArticleApiTest {
    ...
    @Test
    void readTest() {
        ArticleResponse response = read(225169838356365312L);
        System.out.println("response = " + response);
    }
    ...
    @Test
    void deleteTest() {
        restClient.delete().uri("/v1/articles/{articleId}").retrieve();
    }
